...
<head>
  ...
  <title>Stations les plus chaudes - WeatherStation Pro</title>
...
<div class="bg-primary text-white py-5">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-8">
        <h1 class="display-4 fw-bold mb-3">Stations les plus chaudes</h1>
        <p class="lead mb-4">
          Analyse des températures maximales enregistrées par notre réseau de stations météorologiques.
        </p>
      </div>
      <div class="col-lg-4 text-center">
        <i class="bi bi-thermometer-high display-1 opacity-75"></i>
      </div>
    </div>
  </div>
</div>
...
<div class="container my-5">
    ...
    <div class="col-md-4">
      <div class="card text-center h-100">
        <div class="card-body">
          ...
          <h3 class="text-danger">TOP 3</h3>
          <p class="text-muted mb-0">Stations chaudes</p>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card text-center h-100">
        <div class="card-body">
          ...
          <h3 class="text-warning">Temps réel</h3>
  ...
  <div class="row mb-4">
    <div class="col-12 text-center mb-4">
      <h2 class="display-6">Top 3 des stations les plus chaudes</h2>
      <p class="text-muted">Classement des températures les plus élevées en temps réel</p>
    </div>
  </div>
      ...
      <div class="card h-100 border-danger">
        ...
        <div class="card-body">
          ...
          <div class="text-center mb-3">
            <div class="h2 text-danger fw-bold mb-1">
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body text-center py-5">
          ...
          <p class="text-muted mb-4">Impossible de récupérer les stations chaudes</p>
  ...
  <div class="row mt-5">
    ...
    <div class="col-md-6">
      <a href="cold-stations" class="btn btn-info btn-lg w-100">
        <i class="bi bi-thermometer-low me-2"></i>
        Voir les stations froides
      </a>
    </div>
  </div>
</div>
